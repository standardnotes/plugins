...
import { Packages } from '../config/dist/Packages.js'
import { ensureDirExists, doesDirExist, emptyExistingDir } from './ScriptUtils.mjs'
...
const DistDir = path.join(__dirname, '../cdn')
